...
export const MovieIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M7.7 7.7a9 9 0 1 0 8.6 8.6M12 12v-2"></path>
    <path d="m14.2 13-1.4-1.4"></path>
    <path d="M12 17.5V12l-2.5 2.5"></path>
    <path d="m10.2 13 1.4 1.4"></path>
    <path d="M22 2 12 12 2 22"></path>
    <path d="M22 12h-2.5"></path>
    <path d="m17.5 17.5-1.8-1.8"></path>
    <path d="M12 22v-2.5"></path>
    <path d="m6.5 17.5 1.8-1.8"></path>
    <path d="M2 12h2.5"></path>
    <path d="m6.5 6.5 1.8 1.8"></path>
  </svg>
);
